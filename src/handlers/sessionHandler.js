...
async function handleConfirmPublish(interaction, client) {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields(
            { name: "**اسم النظام**", value: `**${data.name || "غير محدد"}**`, inline: true },
            { name: "**نوع النظام**", value: `**${types.length > 0 ? types.join(" / ") : "غير محدد"}**`, inline: true },
