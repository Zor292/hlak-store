...
async function handleSelectType(interaction) {
    ...
    await dmUpdate(interaction, simpleEmbed("**اذكر تفاصيل النظام.**"));
}
...
async function handleConfirmPublish(interaction, client) {
    ...
    // حفظ النظام في DB اولاً للحصول على الـ ID
    ...
    // الفيديوهات في رسائل منفصلة قبل الكونتينر
